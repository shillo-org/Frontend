        ...
        <div className="flex justify-between items-center px-6 py-4 border-b-2 border-gray-200 bg-gradient-to-r from-gray-50 to-gray-100">
          <h3 className="text-xl font-bold flex items-center">
            {selectedAgent === "twitter" && (
              <svg
                className="w-6 h-6 mr-2 text-[#1DA1F2]"
                fill="currentColor"
                viewBox="0 0 24 24"
                aria-hidden="true"
              >
            ...
            {selectedAgent === "discord" && (
              <svg
                className="w-6 h-6 mr-2 text-[#5865F2]"
                fill="currentColor"
                viewBox="0 0 24 24"
                aria-hidden="true"
              >
            ...
            {selectedAgent === "instagram" && (
              <svg
                className="w-6 h-6 mr-2 text-[#E4405F]"
                fill="currentColor"
                viewBox="0 0 24 24"
                aria-hidden="true"
              >
            ...
            Configure{" "}
            {selectedAgent.charAt(0).toUpperCase() + selectedAgent.slice(1)} AI
            Agent
          </h3>
          <button
            type="button"
            ...
            <div className="mb-6 border-2 border-dashed border-gray-200 rounded-lg p-4 bg-gray-50">
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 bg-white flex flex-col items-center justify-center cursor-pointer hover:bg-gray-50 transition-colors">
                ...
                <p className="text-sm text-gray-500 mb-1">
                  Drag and drop a character JSON file here
                </p>
              </div>
            ...
            <div className="mb-6">
              ...
              <div className="mb-4">
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Leave blank to use Shillo's shared API credits.
                </p>
              </div>
              ...
              <div className="mb-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {["Male", "Female", "Robot", "Child", "Custom"].map(
                    (voice) => (
                      <button
                        key={voice}
                        type="button"
            ...
            <div className="mb-6">
              ...
              <div className="mb-4">
                ...
                <textarea
                  ...
                  placeholder={`The official ${selectedAgent} AI assistant for ${
                    tokenName || "our memecoin"
                  }. I share updates, engage with the community, and answer questions about our project.`}
                />
              </div>
              ...
              <div className="mb-4">
                ...
                <div className="flex flex-wrap gap-2 bg-gray-50 p-3 rounded-lg border border-gray-200">
                  {[
                    ...
                    <label
                      key={client}
                      className="flex items-center bg-white px-3 py-2 rounded-md border border-gray-200 cursor-pointer hover:bg-gray-50"
                    >
                      <input
                        type="checkbox"
