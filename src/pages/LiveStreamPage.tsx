    ...
    const fetchTokenInfo = async () => {
      ...
      setTimeout(() => {
        ...
        const systemMessage: Message = {
          ...
          user: "System",
          text: `Welcome to the ${
            mockTokenInfo.tokenName
          } live stream! Chat with other viewers and interact with ${
            mockTokenInfo.agentDisplay?.agentName || "the AI agent"
          }.`,
          timestamp: new Date(),
          isAI: false,
        };
        ...
        const initialMessage: Message = {
          ...
          text: `Hey everyone! It's ${
            mockTokenInfo.agentDisplay?.agentName || "your AI agent"
          } here, the face of ${
            mockTokenInfo.tokenName
  ...
  useEffect(() => {
    ...
    const usersInterval = setInterval(() => {
      ...
      if (shouldPost) {
        ...
        const randomMessage =
          otherUserMessages[
            Math.floor(Math.random() * otherUserMessages.length)
          ];
