        ...
        {isLoading ? (
          ...
          <div className="text-center p-12 bg-white/80 backdrop-blur-sm rounded-xl border-4 border-black">
            <p className="text-2xl font-bold mb-2">
              No streams found matching your filter.
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredStreams.map((stream) => (
              ...
              >
                <div
                  className="bg-white rounded-xl border-6 border-black overflow-hidden transition-all duration-300 
                ...
                >
                  ...
                  <div className="p-4 border-t-4 border-black bg-[#FCFCE6] group-hover:bg-white transition-colors duration-300">
                    ...
                    <p
                      data-title={stream.tokenDescription}
                      className="text-gray-600 flex items-center gap-2 font-medium"
                    >
